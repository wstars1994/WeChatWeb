...
class HttpClient():
    ...
    def rq(self,url, data=None, headers={}):
        HttpClient.res_headers.update(headers);
        print(HttpClient.res_headers);
        req = requestLib.Request(url, data, HttpClient.res_headers);
    ...
    def __set_res_cookies(self,headers):
        ...
        HttpClient.res_headers.update(new_cookie);
